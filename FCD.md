...
> **METHOD 1 — TWO-LAYER PREIMAGE STRUCTURE AND FORWARD SECRECY**
>
...
> **E_ext SYNCHRONIZATION PROTOCOL — REQUIRED BEFORE APPLYING METHOD 2**
>
...
|-------------------|--------------------------------------------------------------|-------------------------|-----------------------------------------------|------------------|----------------------------------------------------------------|--------------------------------------------------------------------|
| Enqpy™ PDAF_SEC   | Shannon underdetermination (Ideal System — proved \[12,13\]) | Unconditional           | 2 bits (exact; canonical)                     | ≥ 128–256 bit    | MAC required (Poly1305/HMAC); structured-PT origin inference supplementary | ~900 MB/s (PDAF_SEC + Poly1305, portable C; §10.2) |
| AES-256-GCM       | Computational hardness (block cipher)                        | Partial (Grover halves) | 0 bits                                        | 256 bits fixed   | AEAD tag 28 bytes                                              | ~10 MB/s (portable GHASH); 3,000+ MB/s (AES-NI)                    |
| ChaCha20-Poly1305 | Computational hardness (ARX)                                 | Partial (Grover halves) | 0 bits                                        | 256 bits fixed   | Poly1305 28 bytes                                              | ~351 MB/s (portable C)                                            |
...
| 6                   | DFT (Spectral)<sup>†</sup>     | 0.287107    | **PASS**           |
...
> **INITIAL SETUP**
>
> Credentials — OpenID, EK, QK, OR_CTR = 0 (pre-shared out-of-band)
