...
- The formal proof paper — *Ciphertext-Only Plaintext Equivocation in a Finite-Key MOD16 Stream Cipher, with a Characterized Known-Plaintext Boundary* (Rev 5.1), and its LaTeX source. Canonical link: https://enqpy.com/technical.html
